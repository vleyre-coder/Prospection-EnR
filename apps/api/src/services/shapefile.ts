    ...
    { nom: `${nomCouche}.cpg`, contenu: Buffer.from('UTF-8', 'latin1') },
    {
      ...
      contenu: Buffer.from(
        [
          ...
          "  indicatifs et n'ont aucune valeur juridique. Seul un document d'arpentage établi",
          '  par un géomètre-expert fait foi.',
          "- Les scores sont une aide à la décision, pas une garantie de faisabilité. Chaque",
          '  donnée doit être re-vérifiée au moment du dépôt et à l\'échelon départemental.',
          '- Les capacités de raccordement sont indicatives et non engageantes.',
          '',
          'LECTURE DES CHAMPS DE SCORE',
          "- STATUT porte le feu tricolore. Un statut 'rouge' peut signifier deux choses très",
          '  différentes : une mauvaise note, ou une exclusion réglementaire. Les distinguer :',
          "- ÉCARTÉE valant 'oui' signale une parcelle écartée par un critère réglementaire NON",
          '  derogeable. Elle ne doit pas être démarchée.',
          '- NB_KO_BLOQ compte ces critères bloquants ; NB_KO compte TOUS les critères',
          '  rédhibitoires, y compris ceux qui sont derogeables (STECAL, modification de PLU) et',
          '  qui conditionnent un projet sans l\'exclure.',
          '',
          'NOTE TECHNIQUE',
          '- Le format DBF limite les noms de champs a 10 caractères : certains noms ont été',
