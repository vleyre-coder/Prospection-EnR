    ...
    { nom: `${nomCouche}.cpg`, contenu: Buffer.from('UTF-8', 'latin1') },
    {
      ...
      contenu: Buffer.from(
        [
          ...
          "- STATUT porte le feu tricolore. Un statut 'rouge' peut signifier deux choses tres",
          '  differentes : une mauvaise note, ou une exclusion reglementaire. Les distinguer :',
          "- ECARTEE valant 'oui' signale une parcelle ecartee par un critere reglementaire NON",
          '  derogeable. Elle ne doit pas etre demarchee.',
          '- NB_KO_BLOQ compte ces criteres bloquants ; NB_KO compte TOUS les criteres',
          '  redhibitoires, y compris ceux qui sont derogeables (STECAL, modification de PLU) et',
