...
| Risques | Géorisques (BRGM) | argiles, cavités, mouvements de terrain, PPRN, PPRT, TRI, sites pollués, ICPE, **zonage sismique**, **potentiel radon**, **établissement SEVESO le plus proche** | les PPR sont recensés **au niveau communal** : l'application signale la présence d'un PPR mais **ne peut pas déterminer le zonage applicable à la parcelle** (rouge, bleu…). Ce zonage reste à lire sur le règlement du PPR. Le zonage sismique (art. D.563-8-1 C. env.) et le potentiel radon (arrêté du 27/06/2018) sont en revanche **communaux par nature juridique** : il n'existe pas d'échelon inférieur, et la valeur de la commune est celle qui s'applique à la parcelle. La recherche d'établissements SEVESO porte sur un rayon de **2 km** autour du centroïde. |
